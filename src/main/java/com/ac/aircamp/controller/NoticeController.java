...
public class NoticeController {
	...
	@GetMapping("/list")
	public String notice(Search search, Model model) {
	...
	@GetMapping("/detail")
	public String noticeRead(@RequestParam("no_no") int no_no, Search search, Model model) {
   ...
   // 업데이트 폼으로 이동
	@GetMapping("/update")
   public String noticeUpdateForm(@ModelAttribute Notice notice, Model model, Search search) {
