	...
	<div id="board-form">
		...
		<form method="post" action="join" onsubmit="return boardCheck();">
			<table class="board-table">
				<tr>
					<th rowspan="2">아이디</th>
					<td><input type="text" name="u_id" id="u_id" maxlength="12" 
						placeholder="아이디는 영문(소문자),숫자로 4~12자 사이로 입력하세요"/></td>
					<td><input type="button" id="id-check" value="중복검사"
						onclick="return idCheck();"><td>
				</tr>
				<tr id="id-result">
					<td colspan="2"></td>
				</tr>
				...
				<tr>
					<th>비밀번호 확인</th>
					<td colspan="2"><input type="text" name="u_pwd2" id="u_pwd2" /></td>
				</tr>
				<tr>
					<th>닉네임</th>
